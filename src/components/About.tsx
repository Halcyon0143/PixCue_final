        ...
        <div className="material-grid">
          <div className="col-span-4 md:col-span-4 lg:col-span-6 flex items-center">
            <div className="relative">
              ...
              <div className="absolute -bottom-4 -right-4 w-24 h-24 bg-secondary-100 rounded-lg"></div>
              <div className="relative z-10 bg-white rounded-lg p-6 elevation-2">
                <h3 className="mb-6">Our Core Values</h3>
          ...
          <div className="col-span-4 md:col-span-4 lg:col-span-6 mt-12 lg:mt-0">
            <div className="space-y-6">
              <h3>Your Brand's Social Media Partner</h3>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-8">
                <div className="bg-white rounded p-4 elevation-1 hover:elevation-2 transition-shadow">
